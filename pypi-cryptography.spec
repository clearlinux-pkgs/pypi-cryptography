...
Source0  : https://files.pythonhosted.org/packages/67/82/9dd8ef695c7f928b25927e8956f73bdba09a752a51871678f320c498c535/cryptography-37.0.3.tar.gz
...
%prep
%setup -q -n cryptography-37.0.3
cd %{_builddir}
tar xf %{_sourcedir}/cryptography-vendor-37.0.2.tar.xz
cd %{_builddir}/cryptography-37.0.3
mkdir -p ./
cp -r %{_builddir}/cryptography-vendor-37.0.2/* %{_builddir}/cryptography-37.0.3/./
pushd ..
cp -a cryptography-37.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655855903
...
cp %{_builddir}/cryptography-37.0.3/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/pypi-cryptography/de33ead2bee64352544ce0aa9e410c0c44fdf7d9
cp %{_builddir}/cryptography-37.0.3/LICENSE.BSD %{buildroot}/usr/share/package-licenses/pypi-cryptography/ea5b412c09f3b29ba1d81a61b878c5c16ffe69d8
cp %{_builddir}/cryptography-37.0.3/LICENSE.PSF %{buildroot}/usr/share/package-licenses/pypi-cryptography/acf6b1628b04fe43a99071223cdbd7b66691c264
